...
class Plp:
    ...
    def product_2(self):
        try:
            ...
            logging.info("Eye Brow tag for second product is: %s", check_second_eye_brow_tag.text)
    ...
    def product_3(self):
        try:
            ...
            logging.info("Eye Brow tag for third product is: %s", check_third_eye_brow_tag.text)
    ...
    def product_4(self):
        try:
            ...
            logging.info("Eye Brow tag for fourth product is: %s", check_fourth_eye_brow_tag.text)
            ...
            click_on_fourth_buy_now_cta = WebDriverWait(self.driver, 10).until(
                EC.presence_of_element_located((By.XPATH, PlpAllProducts.product4_buy_now_cta)))
            time.sleep(1)
